...
app.controller('HighlightsCtrl', ['$scope', function HighlightsCtrl($scope) {
    ...
    $scope.rccStructureElements = [
        ...
        },
        {
            ...
            "content" : "Analysis is done based on actual reinforcement steel bars provided for the given section and load. Report has reference to different applicable clauses as per IS 456 : 2000 for quick reference. Some of the key figures and tables are also provided for instant verification of the design data."
        },
        {
            "name": "Column (Square/Rectangular)",
            "subNav": [],
            "content":  "Report summary includes total concrete volume, quantity of cement and steel required for the job that would help in material requirement planning to complete the casting job."
        },
        {
            "name": "Round Column",
            "subNav": [],
            "content":"A RCC structure may have many different elements such as footing, column, beam, slab etc. Therefore each structure can be saved with unique title where one can add as many elements to this structure with reference name or code number for identification. A file summary is also provided that gives total structure summary along with individual element material summary."

        },
        {
            "name": "Footing",
            "subNav": [],
            "content":   "Users can also create many different files for the same structure for design and cost optimization."
        },
        {
            "name": "Staircase-A (on Slab)",
            "subNav": [],
            "content": "App provides a short cheklist for each element to facilitate on-site data collection that helps in the analysis. In addition, App notes gives brief description of different terminology used with design data and refernce to IS 456 : 2000."
        },
        {
            "name": "Staircase-B (on Slab)",
            "subNav": [],
            "content":  "This app can be a very helpful tool for engineers and contractors to evaluate any rcc structure element before casting to ensure full compliance under IS 456 : 2000 code for its integrity and fail safe design under given load conditions."
        }
    ];
